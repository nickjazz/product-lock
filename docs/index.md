...
[View on GitHub](https://github.com/nickjazz/product-lock){: .btn .fs-5 .mb-4 .mb-md-0 }
...
Give the [Generator Guide]({{ site.baseurl }}/generator-guide) to an AI and point it at your codebase:

> "Read this guide, then analyze this codebase and generate a product.lock.json."

### Have AI review against one

Give the [Reviewer Guide]({{ site.baseurl }}/reviewer-guide) to a *different* AI, along with the lock and codebase:
